...
- a local Git `prepare-commit-msg` hook is responsible for staging timestamped changelog entries into the same commit that triggered them, unless the commit subject includes `[skip-changelog]`
